...
expectNotContains('public/index.html', 'id="pasule-station-note"');
...
expectContains('public/index.html', 'data-pasule-home-firefly');
expectContains('public/index.html', 'data-pasule-home-left');
expectContains('public/index.html', 'data-pasule-home-stream');
expectContains('public/index.html', 'data-pasule-home-right');
expectContains('public/index.html', 'data-pasule-static-banner');
expectContains('public/index.html', 'data-pasule-home-music-card');
expectNotContains('public/index.html', 'data-pasule-home-hero');
expectNotContains('public/index.html', 'pasule-hero-dot');
...
expectContains('public/style.css', '.pasule-home-firefly');
expectContains('public/style.css', '.pasule-home-stream');
expectNotContains('public/style.css', '.pasule-home-carousel');
...
expectNotContains('public/style.css', '.pasule-swiper');
